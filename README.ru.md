# Овчарня : контроль доступа в интернет для семьи

Русский | [English](README.md)

**Овчарня** — система семейного управления доступом в интернет для OpenWRT.

Проект планируется как LuCI-приложение, backend-сервис для OpenWRT, Android-приложение **Овчарня** и интеграция с ботом в мессенджере для управления домашним интернетом.
...
- Управлять доступом домашних устройств в интернет через LuCI.
...
- Синхронизировать имена устройств и постоянные IP с DHCP static leases в OpenWRT.
